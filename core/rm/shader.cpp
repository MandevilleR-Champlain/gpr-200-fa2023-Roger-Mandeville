...
namespace rm {
	...
	{
		unsigned int vertexShader = rm::createShader(GL_VERTEX_SHADER, vertexShaderSource);
		unsigned int fragmentShader = rm::createShader(GL_FRAGMENT_SHADER, fragmentShaderSource);
